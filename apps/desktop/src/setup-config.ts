 ...
 * securely address a Aidex server.
 */
export function normalizeServerUrl(input: string): string | null {
  ...
  // Aidex serves its renderer, RPC, and auth routes from one origin. Keeping a
...
/** Each Aidex origin gets its own persistent cookie and storage partition. */
 ...
 * metadata endpoints. Cleartext HTTP to them is never a legitimate Aidex
