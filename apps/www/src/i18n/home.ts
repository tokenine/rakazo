...
const HOME_COPY: Record<Locale, HomeCopy> = {
  ...
  ko: {
    ...
    hero: {
      ...
      lead: "Aidex는 오픈소스 Grok Bot 대안입니다. 봇에게 실제 업무를 맡기세요. 봇이 도구에 로그인하고, 당신처럼 사용하며, 필요할 때 돌아와 묻습니다.",
      getStarted: "시작하기",
      viewOnGithub: "GitHub에서 보기",
    ...
    selfHost: {
      eyebrow: "셀프 호스트",
      heading: "컴퓨터는 당신 것",
      copy: "당신 머신에서 Aidex를 실행하세요. 키, 모델, 데이터는 모두 당신 것.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "Aidex는 Apache-2.0 라이선스이며, 당신 머신에서 당신 모델 키로 실행됩니다. 잠긴 기능도, 외부로 연락하는 것도 없습니다.",
    ...
    cta: {
      heading: "첫 봇을 만나보세요",
      copy: "미뤄 두었던 일을 Aidex에 맡기고, 후속까지 맡기세요.",
      getStarted: "시작하기",
      viewOnGithub: "GitHub에서 보기",
    ...
    getStartedDialog: {
      ...
      cloudHint: "호스팅 Aidex가 곧 옵니다. 이메일을 남겨 주세요.",
      back: "뒤로",
      successTitle: "등록되었습니다.",
      successCopy:
        "호스팅 Aidex가 준비되면 메일로 알려 드립니다. 오늘 시작하려면 이 페이지의 셀프 호스트 섹션으로 이동하세요.",
      done: "완료",
      viewOnGithub: "GitHub에서 보기",
    },
    waitlist: {
