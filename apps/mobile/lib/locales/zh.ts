export const ZH_MESSAGES: Record<string, string> = {
  ...
  "Could not load sign-in settings": "无法加载登录设置",
  "Could not send the sign-in code": "无法发送登录验证码",
  "Could not verify the code": "无法验证代码",
  "This server does not have email delivery configured, so sign-in codes cannot be sent.":
    "此服务器未配置电子邮件发送功能，无法发送登录验证码。",
  ...
  "Enter your Ai7 server address.": "输入你的 Ai7 服务器地址。",
  "Show less": "收起",
  Members: "成员",
  Max: "最高",
  Minimal: "最低",
  ...
  "Point this app at your self-hosted Ai7 origin, the same HTTPS URL you open in a browser.":
    "将此应用指向你自托管的 Ai7 源站，地址与你在浏览器中打开的 HTTPS URL 相同。",
  Private: "私有",
  Providers: "提供商",
  ...
  "Show {label}": "显示 {label}",
  "Sign in": "登录",
  "Sign in to Ai7": "登录 Ai7",
  "Sign out": "退出登录",
  "Sign up": "注册",
  "Sign up for Ai7": "注册 Ai7",
  "Sign-in": "登录",
  "Sign-up": "注册",
  ...
  "That URL did not look like a Ai7 server": "该地址看起来不是 Ai7 服务器",
  ...
  "Paste the OpenAI-compatible address from your server. Ai7 adds /v1 if needed.":
    "粘贴你服务器的 OpenAI 兼容地址。如有需要，Ai7 会自动补上 /v1。",
  Paused: "已暂停",
  Prompt: "提示词",
