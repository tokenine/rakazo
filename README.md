...
![Ai7 — AI teammates you actually own](./docs/readme-hero.png)

Ai7 is an open-source platform for running persistent AI teammates. It is available on the web,
...
Ai7 is in beta. Learn more at [rakazo.com](https://rakazo.com).
...
The installer downloads the Compose files, creates `.env` with random secrets, and starts Ai7.
...
The Electron and Expo apps are clients of the same Ai7 API used by the web app.
...
On first run the desktop app asks whether to run Ai7 on this computer or connect to an existing
...
app verifies Ai7's health endpoint before saving, and later launches go straight to that
instance. The stack keeps running after the app quits; **Stop Local Stack** in the application
menu turns it off.

Use **Change Ai7 Server…** in the application menu to reconnect. Closing that window without
...
Ai7 is licensed under the [Apache License 2.0](./LICENSE).

Questions and ideas are welcome in the [Ai7 Discord community](https://discord.gg/RWwKa2Sn7h).
